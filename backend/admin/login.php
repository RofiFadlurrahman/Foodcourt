...
<head>
    ...
    <title>Masuk Admin - Sistem Foodcourt</title>
    <!-- Bootstrap 5 CSS CDN -->
...
<body>
    ...
    <div class="login-card text-center">
        ...
        <h3 class="text-title">Masuk Admin</h3>
        <p class="text-subtitle">Portal khusus pengelola & administrator sistem</p>
        ...
        <div class="mt-2 text-center" style="font-size: 13px;">
            <span class="text-muted">Belum punya akun admin? </span>
            <a href="register.php" class="text-decoration-none" style="color: #a78bfa; font-weight: 600;">Daftar di sini</a>
        </div>
